export default function SearchCriteria({ selected = [], onChange }) {
  ...
  return (
    <div className="grid mt-2 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-3 dark:text-gray-200">
      <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
        <input
          type="checkbox"
          checked={selected.includes("sleeping Essential")}
          name="sleeping Essential"
      ...
      <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
        <input
          type="checkbox"
          checked={selected.includes("clothing Essential")}
          name="clothing Essential"
          onChange={handleCbClick}
        />
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
        <input
          type="checkbox"
          checked={selected.includes("survival Essential")}
      ...
      <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
        <input
          type="checkbox"
          checked={selected.includes("cooking Essential")}

...
export default function Header() {
  ...
  return (
    <header className="bg-emerald-600 flex justify-between max-w-9xl py-6 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="rounded-full flex gap-2 px-3 py-1 border-2 pl-0">
          <div className="text-white rounded-full overflow-hidden"></div>
          {!user && (
            <>
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="font-semibold text-white text-2xl">Login</span>
            </>
          )}
          {user && (
            <>

        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <nav className="mb-6 md:mb-0">
            <ul className="flex flex-wrap justify-center gap-6">
              ...
              <li>
                <Link to={"/campsites"} className="hover:text-emerald-500 transition-colors">
                  Browse Campsites
                </Link>
              </li>
              <li>
                <Link to={"/campgears"} className="hover:text-emerald-500 transition-colors">
                  Rent Camp Gears
                </Link>
              </li>
              <li>
                <Link to={user ? "/account" : "/login"} className="hover:text-emerald-500 transition-colors">
